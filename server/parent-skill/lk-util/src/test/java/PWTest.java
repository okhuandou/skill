...
public class PWTest {
	...
	public void userTokenEnt() throws Exception {
		String post = httpUtil.post("http://172.16.130.102:8090/pw/user/encrypt.action", null,
				// byte[] post =
	...
	public void userdecMd() throws Exception {
		...
		String post = httpUtil.post("http://127.0.0.1:8080/pw/user/decMd.action", null,
	...
	public void usertransEnc() throws Exception {
		...
		String post = httpUtil.post("http://127.0.0.1:8080/pw/user/transEnc.action", null,
				"content=6af93fa45cfc39e697ee658d2dc8c25f&"
						+ "userId=00000000-6ffd-a873-7a82-3a900033c587%2B18:dc:56:b8:12:29%2B18:DC:56:BA:12:29&"
	...
	public void getUserKey() throws Exception {
		...
		// "r1=12345678");
		String post = httpUtil.post("http://172.16.130.102:8090/pw/getUserKey.action", null, "r1=12345678");
		System.out.println(1);
		System.out.println(new String(post));
	}
}
